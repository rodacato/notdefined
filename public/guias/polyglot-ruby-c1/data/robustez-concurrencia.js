...
(function (G) {
  ...
  D.fichas.push({
    ...
    snippet: [
      ...
      'rescue IOError',
      '  raise Payments::Unavailable, "gateway sin respuesta"   # cause se conserva',
      'end',
      '',
      'begin',
      '  charge',
      ...
      'end',
      '# => [Payments::Unavailable, "gateway sin respuesta", IOError, "timeout del gateway"]',
      '',
  ...
  D.fichas.push({
    ...
    snippet: [
      ...
      'end',
      '',
      'swallows_it    # => :all_good   # nadie supo del "algo grave"',
      '',
      'def cleans_only',
      '  raise "algo grave"',
      'ensure',
      ...
      pasos: [
        {
          ...
          predice: {
            pregunta: 'Antes de avanzar: ¿qué te regresa <code>swallows_it</code>, y qué pasa con el <code>"algo grave"</code>?',
            opciones: [
