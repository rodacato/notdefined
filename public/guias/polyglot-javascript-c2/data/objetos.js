    ...
    widget: {
      ...
      variants: [{
        ...
        frames: [
          ...
          { code: ["const g = user.greet;", "g();"], phase: "Por defecto", apunta: ["undefined"], out: ["TypeError: this.name"],
          ...
          { code: ["setTimeout(() => user.greet())"], phase: "Arrow (léxico)", apunta: ["el this de fuera"], out: ["'Hola, soy Ana'"],
            cap: "La <strong>arrow</strong> no tiene this propio: lo toma del \u00e1mbito donde se escribi\u00f3. Dentro llamamos <span class=\"inline-code\">user.greet()</span> con enlace impl\u00edcito, as\u00ed que funciona." },
        ],
      }],
    },
  };
