...
(function (G) {
  ...
  D.topics["modulos-esm-cjs"] = {
    ...
    lede: "Los dos sistemas de m\u00f3dulos de JavaScript no son intercambiables. <span class=\"mono\">require</span> es s\u00edncrono y copia valores; <span class=\"mono\">import</span> resuelve un grafo en fases y entrega <em class=\"serif-italic\">enlaces vivos</em>. Ah\u00ed nace casi todo el dolor del interop.",
    breve: [
    ...
    mito: "<p>\u00ab<span class=\"inline-code\">import</span> es <span class=\"inline-code\">require</span> con az\u00facar sint\u00e1ctica.\u00bb No: <span class=\"inline-code\">require</span> es s\u00edncrono y te da una <strong>copia</strong> del valor; <span class=\"inline-code\">import</span> es as\u00edncrono, en fases, est\u00e1tico y te da <strong>enlaces vivos</strong>. Por eso el interop duele donde duele: el <span class=\"inline-code\">default</span> de un CJS se envuelve, los named exports se detectan por heur\u00edstica, y no hay <span class=\"inline-code\">top-level await</span> dentro de CJS.</p>",
    recursos: [
