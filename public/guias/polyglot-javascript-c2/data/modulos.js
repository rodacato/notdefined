...
(function (G) {
  ...
  D.topics["modulos-esm-cjs"] = {
    ...
    snippet: [
      ...
      "mod.n;   // => 1",
      "",
      "// Con CommonJS, `const { n } = require(...)` se habr\u00eda quedado en 0:",
      "// require entrega el valor, import entrega el enlace.",
    ...
    callout: {
      ...
      cmd: "node -e \"import('data:text/javascript,export let n=0;export const b=()=>n++').then(m=>{const antes=m.n;m.b();console.log(antes,m.n)})\"",
      sale: "0 1",
    },
    recursos: [
