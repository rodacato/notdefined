...
(function (G) {
  ...
  D.topics["pipeline-ejecucion"] = {
    ...
    callout: {
      dice: "Corre esto y luego agrégale <code>lazy()</code> al final: la función que nadie llama nunca llega a bytecode.",
      cmd: "node --print-bytecode --print-bytecode-filter=lazy -e \"function lazy(){return 1}\" | grep -c \"generated bytecode\"",
      sale: "0 — y 1 en cuanto la llamas",
    },
    recursos: [
  ...
  D.topics["ignition-bytecode"] = {
    ...
    callout: {
      ...
      sale: "Ldar a1 · Mul a0, [1] · AddSmi [1], [0] · Return",
    },
    recursos: [
  ...
  D.topics["niveles-jit"] = {
    ...
    callout: {
      ...
      cmd: "node --allow-natives-syntax -e \"function f(a,b){return a+b};const o=()=>(%GetOptimizationStatus(f)&16)!==0;for(let i=0;i<2e5;i++)f(i,1);console.log(o());f('x','y');console.log(o())\"",
      sale: "true, luego false",
    },
    recursos: [
