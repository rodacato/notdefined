...
(function (G) {
  ...
  D.topics["niveles-jit"] = {
    ...
    mito: "<p>\u00abUn JIT siempre hace tu c\u00f3digo m\u00e1s r\u00e1pido.\u00bb No gratis: compilar <em class=\"serif-italic\">cuesta</em>, y la desoptimizaci\u00f3n tiene precio. Una funci\u00f3n que cambia constantemente de tipos (megam\u00f3rfica) puede quedarse atascada bajando y subiendo de nivel. Escribir con tipos <strong>consistentes</strong> es lo que deja al JIT trabajar.</p>",
    recursos: [
      ...
      variants: [{
        ...
        frames: [
          { phase: "0 invocaciones", nivel: ["Ignition \u00b7 1\u00d7"], fb: ["(sin datos)"],
            cap: "A\u00fan sin ejecutar. La primera llamada correr\u00e1 en <strong>Ignition</strong>, el int\u00e9rprete de bytecode." },
          ...
          { phase: "\u26A1 lleg\u00f3 un string", nivel: ["Ignition \u00b7 1\u00d7"], fb: ["number \u2717 string \u2192 megam\u00f3rfico"],
