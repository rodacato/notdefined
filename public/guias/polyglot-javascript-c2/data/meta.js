...
(function (G) {
  ...
  D.meta = {
    ...
    colophon: "Cada ficha arranca del fundamento, lo hace visible con un widget que puedes pausar y avanzar paso a paso, y cierra con las fuentes que construyeron el motor. <span class=\"mono\" style=\"font-size:11px;color:var(--color-fg-faint)\">evaluado en julio de 2026 · locale: js-VM</span>",
  };
