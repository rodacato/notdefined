    ...
    const masthead = h("header", { class: "masthead" },
      h("div", { class: "mast-top" },
        h("div", { class: "mark" }, G.glyph(),
          h("div", null,
            h("div", { class: "mast-eyebrow" }, "Catálogo visual · aprendizaje por trade-offs"),
            h("div", { class: "mast-title" },
              h("span", { class: "num" }, "1001"), " — " + D.META.titulo))),
        h("div", { class: "edition" },
          h("div", null, D.META.edicion.replace("Edición 2026 · ", ""), " "),
